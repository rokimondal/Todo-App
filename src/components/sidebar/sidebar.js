    ...
    return <div className=" min-h-[calc(100vh-2rem)] w-80 h- bg-gray-200 m-4 p-4 rounded-lg  sm:w-60 md:w-80 flex flex-col justify-between">
        <div >
            ...
            <div>
                ...
                <div className="ml-1">
                    <div className="flex w-full justify-between items-center py-1 pr-1 hover:bg-gray-300 rounded p-1">
            ...
            <div>
                ...
                <div className="ml-1 flex flex-wrap">
                    <div className="text-xs tracking-tighter text-gray-600 bg-sky-300 hover:text-gray-800 hover:bg-sky-400 py-1 px-2 rounded w-fit m-1">Tag 1</div>
                    <div className="text-xs tracking-tighter text-gray-600 bg-yellow-300 hover:text-gray-800 hover:bg-yellow-400 py-1 px-2 rounded w-fit m-1">Tag 1</div>
                    <div className="text-xs tracking-tighter text-gray-600 bg-pink-300 hover:text-gray-800 hover:bg-pink-400 py-1 px-2 rounded w-fit m-1">Tag 1</div>
                    <div className="text-xs tracking-tighter text-gray-600 bg-purple-300 hover:text-gray-800 hover:bg-purple-400 py-1 px-2 rounded w-fit m-1">Tag 1</div>
                    <div className="text-xs tracking-tighter text-gray-600 bg-orange-300 hover:text-gray-800 hover:bg-orange-400 py-1 px-2 rounded w-fit m-1">Tag 1</div>
                    <div className="text-xs tracking-tighter text-gray-600 bg-gray-300 hover:text-gray-800  px-2 rounded flex items-center w-fit">
            ...
            <div>
                ...
                <div className="ml-1">
                    <div className="text-sm text-gray-500 hover:text-gray-600">cdfwtugvhbkjn</div>
                    <div className="text-sm text-gray-500 hover:text-gray-600">cdfwtugvhbkjn</div>
                    <div className="text-sm text-gray-500 hover:text-gray-600">cdfwtugvhbkjn</div>
                </div>
            </div>
        ...
        <div>
            <div className="mt-4 mr-10">
                <div className="text-[1rem] font-semibold text-gray-600 mb-1 flex justify-center items-center hover:text-gray-500"><MdOutlineSettings className="mr-2 text-xl" />Settings</div>
                <div className="text-[1rem] font-semibold text-gray-600 mb-1 flex justify-center items-center hover:text-gray-500"><RiLogoutBoxLine className="mr-2 text-xl" />Sign out</div>
            </div>
        </div>
    </div>
}